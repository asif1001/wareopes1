// Script to create a non-admin test user in Firebase for access control testing
...
async function createNonAdminUser() {
  try {
    ...
    // Non-admin test user data
    const testUser = {
      employeeNo: "54321",
      fullName: "Regular User",
      email: "regularuser@wareops.com",
    ...
    console.log('Non-admin test user created successfully with ID:', docRef.id);
    ...
    console.error('Error creating non-admin test user:', error);
  }
}
